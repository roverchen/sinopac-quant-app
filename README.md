...
[![Version](https://img.shields.io/badge/version-2.7.0-blue.svg)](REVISIONS.md) [![Build Status](https://img.shields.io/badge/build-passing-brightgreen.svg)]()
...
- **問題**：因 MacOS/雲端環境對交易所官網的連線限制 (SSL/404)，動態抓取標的名單時常失敗，導致掃描範圍縮水至僅剩 5-8 檔股票。
- **修正**：導入「保底名單」機制。即便外部抓取受阻，系統仍能針對台股前 200 檔、美股 NASDAQ 100 等 **500+ 檔核心標的** 執行全盤量化分析，確保 `AutoRobot` 選股範圍最大化。
